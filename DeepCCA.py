...
if __name__ == '__main__':
    ...
    data1 = load_data('microbe_data.pkl.gz', '')
    #data2 = load_data('noisymnist_view2.gz', 'https://www2.cs.uic.edu/~vnoroozi/noisy-mnist/noisymnist_view2.gz')
    data2 = load_data('expression_data.pkl.gz', '')

    print("input data1 has the following shapes:")
    print("train")
    ...
    print("input data2 has the following shapes:")
    print("train")
    ...
    #to check the dimension of new data

   
    

    print("new data has the following shapes:")
    print("train")
...
# to run with theano backend use the following command
